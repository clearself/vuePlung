<template>
  <x-cell
    ...
    <div
      slot="right"
      class="fly-cell-swipe-buttongroup"
      ref="right">
      <a
        class="fly-cell-swipe-button"
        v-for="btn in right"
        :style="btn.style"
...
export default {
  ...
  mounted() {
    this.wrap = this.$refs.cell.$el.querySelector('.fly-cell-wrapper');
...
<style lang="scss" scoped>
  @import "./var.scss";
  @import "./style.scss";
	 .fly-cell-swipe-buttongroup {
        height: 100%;
      }

    	.fly-cell-swipe-button {
        height: 100%;
        display: flex;
        padding: 0 10px;
        line-height: 48px;
      ...
      .fly-cell-wrapper,.fly-cell-left, .fly-cell-right {
